...
export const mockResearchOutput: ResearchOutput = {
  ...
  focusArea: '行政DX',
  policyAnalysis: {
    currentPolicy: 'デジタル社会の実現に向けた重点計画（2025年度版）では、AI・デジタル技術の徹底活用、AI-フレンドリーな環境整備、競争・成長のための協調、安全・安心なデジタル社会、DX推進力の強化を5本柱として掲げています。',
    challenges: [
      'ガバメントAI基盤の構築・運用体制',
      '生成AI活用に伴うセキュリティリスク',
      '自治体システム標準化の期限遵守',
...
export const mockAuditReport: AuditReport = {
  ...
  detailedScores: [
    ...
    { category: '持続可能性', score: 80, comment: 'SaaSモデルによる���続的な収益確保が可能' },
